...
<title>用戶登錄 <?php $chargerCode=GetItemValue('chargerCode'); echo $chargerCode; ?></title>
...
<td width="100" height="40" align="right"><a href="../EN/index.php" class="selectedSTYLE">English</a></td>
</tr>
<tr>
...
<td width="50%" height="30" align="left" class="tbLabelSTYLE"> 用戶名稱 </td>
...
<tr>
<td width="50%" height="30" align="left" class="tbLabelSTYLE"> 密碼 </td>
...
<td width="25%" height="33%" align="center" valign="middle"> <input type="reset" name="clean" value="重置" id="btn" class="numBtnSTYLE" style="background-color:#D1322D;"/> </td>
</tr>
<tr>
...
<td width="25%" height="33%" align="center" valign="middle"> <input type="submit" name="Submit" value="確認" id="btn" class="numBtnSTYLE" onClick="return Checkblank(form1);" style="background-color:#008080;"/> </td>
</tr>
<tr>
