...
<tr>
<td width="100%" height="35" align="left"><a href="media_file.php" class="indexSTYLE">檔案名稱</a></td>
</tr>
<tr>
<td width="100%" height="2" class="line">
</tr>
<tr>
<td width="100%" height="35" align="left"><a href="media_time.php" class="selectedSTYLE">播放設定</a></td>
</tr>
<tr>
<td width="100%" height="2" class="line">
</tr>
...
<tr>
<td width="30" height="30" align="left" class="tbLabelSTYLE"> </td>
<td width="180" height="30" align="left" class="tbLabelSTYLE"> 視頻開始時間 </td>
<td width="390" height="30" align="left" class="editSTYLE"> <input name="videoTimeB" type="text" id="videoTimeB" size="40" maxlength="20" class="editSTYLE" value="<?php  echo GetItemValue('videoTimeB'); ?>" /> </td>
</tr>
<tr>
<td width="30" height="30" align="left" class="tbLabelSTYLE"> </td>
<td width="180" height="30" align="left" class="tbLabelSTYLE"> 視頻停止時間 </td>
<td width="390" height="30" align="left" class="editSTYLE"> <input name="videoTimeE" type="text" id="videoTimeE" size="40" maxlength="20" class="editSTYLE" value="<?php  echo GetItemValue('videoTimeE'); ?>" /> </td>
</tr>
<tr>
<td width="30" height="30" align="left" class="tbLabelSTYLE"> </td>
<td width="180" height="30" align="left" class="tbLabelSTYLE"> 屏保時間 </td>
<td width="390" height="30" align="left" class="editSTYLE"> <input name="SCREENSAVE" type="text" id="SCREENSAVE" size="40" maxlength="20" class="editSTYLE" value="<?php  echo GetItemValue('SCREENSAVE'); ?>" /> </td>
</tr>
<tr>
<td width="30" height="30" align="left" class="tbLabelSTYLE"> </td>
</tr>
