...
<tr>
<td width="100%" height="35" align="left"><a href="auth_net.php" class="indexSTYLE">Platform</a></td>
</tr>
<tr>
<td width="100%" height="2" class="line">
</tr>
<tr>
<td width="100%" height="35" align="left"><a href="auth_local.php" class="selectedSTYLE">Local</a></td>
</tr>
<tr>
<td width="100%" height="2" class="line">
</tr>
...
<tr>
<td width="30" height="30" align="left" class="tbLabelSTYLE"> </td>
<td width="180" height="30" align="left" class="tbLabelSTYLE"> Charger RFID </td>
...
<tr>
<td width="30" height="30" align="left" class="tbLabelSTYLE"> </td>
<td width="180" height="30" align="left" class="tbLabelSTYLE"> Touch Button </td>
<input name="KEYONLY" type="hidden" id="KEYONLY" value="<?php  $tmp=GetItemValue('KEYONLY'); echo $tmp; ?>" />
<td width="360" height="30" align="left" class="editSTYLE"> <input name="KEYONLY_" type="checkbox" id="KEYONLY_" class="checkboxSTYLE" onClick="onCheckBoxClick(this, KEYONLY)" <?php if($tmp=="1") echo "checked"?> /> &nbsp;&nbsp;&nbsp;(Un-Click use Touch LCD Screen)</td>
</tr>
<tr>
<td width="30" height="30" align="left" class="tbLabelSTYLE"> </td>
...
<tr>
<td width="30" height="30" align="left" class="tbLabelSTYLE"> </td>
<td width="180" height="30" align="left" class="tbLabelSTYLE"> Min Charge Current(mA) </td>
