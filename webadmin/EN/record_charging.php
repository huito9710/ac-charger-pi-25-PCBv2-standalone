...
<tr>
<td width="100%" height="35" align="left"><a href="record_charging.php" class="selectedSTYLE">Charge&nbspLog</a></td>
</tr>
<tr>
...
<tr>
<td width="150" height="20" align="center" class="thSubSTYLE"><?php echo "Start Time" ?> </td>
<td width="150" height="20" align="center" class="thSubSTYLE"><?php echo "End Time" ?> </td>
<td width="100" height="20" align="center" class="thSubSTYLE"><?php echo "User" ?> </td>
<td width="100" height="20" align="center" class="thSubSTYLE"><?php echo "Length" ?> </td>
<td width="100" height="20" align="center" class="thSubSTYLE"><?php echo "kWh" ?> </td>
</tr>
<?php
if(empty($_GET['page']))
{
