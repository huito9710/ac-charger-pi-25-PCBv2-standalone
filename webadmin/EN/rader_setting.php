...
<td width="75"  height="35" align="center"><a href="rader_setting.php" class="selectedSTYLE">Radar</a></td>
...
<tr>
<td width="100%" height="35" align="left"><a href="auth_net.php" class="selectedSTYLE">Setting</a></td>
</tr>
<tr>
...
<tr>
<td width="30" height="30" align="left" class="tbLabelSTYLE"> </td>
<td width="180" height="30" align="left" class="tbLabelSTYLE"> Enable Radar Detection </td>
<input name="Rader" type="hidden" id="Rader" value="<?php  $tmp=GetItemValue('Rader'); echo $tmp; ?>" />
<td width="360" height="30" align="left" class="editSTYLE"> <input name="Rader_" type="checkbox" id="Rader_" class="checkboxSTYLE" onClick="onCheckBoxClick(this, Rader)" <?php if($tmp=="1") echo "checked"?> /> </td>
</tr>
<tr>
<td width="30" height="30" align="left" class="tbLabelSTYLE"> </td>
</tr>
